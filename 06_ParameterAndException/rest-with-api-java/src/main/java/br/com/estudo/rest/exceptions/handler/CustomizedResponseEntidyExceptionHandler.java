package br.com.estudo.rest.exceptions.handler;

import br.com.estudo.rest.exceptions.ExceptionResponse;
...
@ControllerAdvice
@RestController
public class CustomizedResponseEntidyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(UnsupportedMathOoperationException.class)
